...
class KuteTextPreference(override val key: Int, override val name: String, val minLength: Int? = null,
                         val maxLength: Int? = null, val regex: String? = null, override val defaultValue: String,
